...
<p>The Icelandic Saga Database is an online resource dedicated to publishing the <strong>Sagas of the
        Icelanders</strong> &mdash; a large body of medieval Icelandic literature. The sagas are prose histories
    describing events that took place amongst the Norse and Celtic inhabitants of Iceland during the period of the
    Icelandic Commonwealth in the 10th and 11th centuries CE.</p>

<p>The Icelandic sagas are believed to have been written in the 13th and 14th centuries CE, perhaps originating in an
    oral tradition of storytelling. While their facticity and authorship is for the most part unknown, they are a widely
    recognized gem of world literature thanks to their sparse, succinct prose style and balanced storytelling. The sagas
    focus largely on history, especially genealogical and family history, and reflect the struggles and conflicts that
    arose amongst the second and third generations of Norse settlers in medieval Iceland, which was in this time a
    remote, decentralised society with a rich legal tradition but no organized executive power.</p>

<p>This website contains <a href="/index_az">all the extant Icelandic family sagas</a>. They are accessible in a variety
    of open formats. The texts use modernised Icelandic orthography. Translations into English and other languages are
    also made available where these exist in the public domain.</p>
    ...
    <div class="medium-6 columns">
        <div class="callout sbox frontpage-box">
            ...
            <ul>
                ...
                <li><a href="http://www.heimskringla.no">Heimskringla.no</a></li>
    ...
    <div class="medium-6 columns">
        <div class="callout sbox frontpage-box">
            ...
            <form action="https://www.paypal.com/cgi-bin/webscr" method="post" style="float: right;">
                ...
                <input type="image"
                    src="https://www.paypalobjects.com/WEBSCR-640-20110306-1/en_US/i/btn/btn_donate_LG.gif" border="0"
                    name="submit" alt="PayPal - The safer, easier way to pay online!">
                <img alt="" border="0" src="https://www.paypalobjects.com/WEBSCR-640-20110306-1/en_US/i/scr/pixel.gif"
                    width="1" height="1">
            </form>
